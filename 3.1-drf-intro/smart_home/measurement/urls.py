...
from measurement.views import SensorListView, MeasurementView, SensorCreateView, SensorUpdateView, SensorDetail
...
urlpatterns = [
    ...
    path('sensor/<pk>/', SensorDetail.as_view(), name='sensor-detail'),
]
